...
import { zodResolver } from "@hookform/resolvers/zod";///npm i react-hook-form zod
import { z } from "zod";
...
const signUpSchema = z.object({
  firstName: z.string().min(2),//firstName: z.string().min(2 ,{ message:"Fist name have must 2 char"}),
